...
public class GiftTab extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        AndroidNetworking.get("https://clothshopping-47373.firebaseio.com/gift/all_app.json")
        ...
        AndroidNetworking.get("https://clothshopping-47373.firebaseio.com/banner/gift.json")
                .setPriority(Priority.HIGH)
                .build()
    ...
    public static GiftTab newInstance(String text) {
        GiftTab giftTab = new GiftTab();
        Bundle b = new Bundle();
        b.putString("msg", text);

        giftTab.setArguments(b);
        return giftTab;
    }
